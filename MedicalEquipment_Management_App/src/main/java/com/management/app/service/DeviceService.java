...
public class DeviceService {
	...
	// 検索
	public List<DeviceModel> searchDevices(Integer managementCd, String equipmentName, String equipmentType,
			String notes,
			String department, String boughtEnterprise, Integer usefulLife) {
		return repository.searchDevices(managementCd, equipmentName, equipmentType, notes, department,
				boughtEnterprise, usefulLife);
	}

	// ソート
	public List<DeviceModel> getAllDevicesSortedById() {
